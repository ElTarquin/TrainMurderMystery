...
public interface TMMBlocks {
    ...
    Block SMALL_TRAIN_DOOR = registrar.createWithItem("small_train_door", new SmallDoorBlock(() -> TMMBlockEntities.SMALL_TRAIN_DOOR, AbstractBlock.Settings.copy(SMALL_GLASS_DOOR).sounds(BlockSoundGroup.COPPER)), TMMItems.DECORATION_GROUP);
